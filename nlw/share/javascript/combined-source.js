...
ST.Tags.prototype = {
    ...
    deleteTag: function (tagToDelete) {
        this.showTagMessage(loc('Removing tag') + ' ' + html_escape(tagToDelete));
    ...
    _update_delete_list: function () {
        if (this._deleted_tags.length > 0) {
            Element.update(this.element.deleteTagsMessage, html_escape(loc('These tags have been removed: ') + this._deleted_tags.join(', ')));
