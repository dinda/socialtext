// BEGIN l10ns.js
var LocalizedStrings = {"ja":{"Use Advanced Mode for %1":"%1 については高度編集モードを使用してください。","Could not retrieve the latest revision of the page":"ページの最新のリビジョンを取得することができませんでした。","Enter a tag and click \\\"Add another tag\\\". The tag will be saved when you save the page.":"タグを入力し ”別のタグを追加” をクリックしてください。","Convoq Link":"Convoq リンク","Display the search results for the given phrase within a workspace. Use this form to edit the properties for the search.":"ワークスペース内で使われているフレーズについて検索結果を表示します。このフォームを使用して検索のプロパティを編集してください。","Attachment filename:":"添付ファイル名:","Switch to %1 to use this feature.":"この機能を使うには %1 に切り替えてください。","Pages tagged with":"でタグの付いたページ","Page title is too long after URL encoding":"URL のエンコード処理を行うと、ページタイトル が長くなりすぎます。全角文字は28字まで使用できます。","Cancel":"キャンセル","User Name":"ユーザ名","Display the content of an Atom feed. Use this form to edit the properties of the inline Atom feed.":"Atom フィードの内容を表示します。このフォームを使用してインラインAtom フィードのプロパティを編集してください。","Requires one of: %1":"次から少なくとも 1つは必要です: %1","Create Table":"表の作成","Link to Attachment":"添付ファイルへのリンク","Can't have a 0 for a size.":"0 は入力できません。","Optionally, specify that the page contents should be displayed.":"オプションとして、ページの内容を表示するように指定できます。","You have unsaved changes. Are you sure you want to navigate away from this page? If you click 'OK', all edit changes will be lost. Click 'Cancel' if you want to stay on the current page.":"変更が保存されていません。 このページから離れますか？ 'OK' をクリックすると、すべての変更内容が失われます。変更を保存し、このページに残りたい場合は、'キャンセル' をクリックしてください。","There are no optional properties for a Convoq Link.":"Convoq リンクに関するオプショナルプロパティはありません。","Display a link to a file attached to a page. Use this form to edit the properities of the link.":"ページに添付されているファイルへのリンクを表示します。このフォームを使用してリンクのプロパティを編集してください。","Loading...":"読み込み中...","wiki text":"wiki テキスト","Display a link to a list of pages with a specific tag. Use this form to edit the properties of the link.":"特定のタグがついたページ一覧へのリンクを表示します。このフォームを使用してリンクのプロパティを編集してください。","Click \\\"Browse\\\" to find the file you want to upload. When you click \\\"Upload file\\\" your file will be uploaded and added to the list of attachments for this page.":"\\\"参照\\\"をクリックし、アップロードしたいファイルを選択してください。 \\\"ファイルのアップロード\\\" をクリックすると、そのファイルがアップロードされ、このページの添付リストに追加されます。","Edit More":"さらに編集","'%1' has an invalid value":"'%1' に無効な値が含まれます","Table Edit Tip":"表の編集のコツ","Pages in:":"ページ:","You cannot compare a revision to itself.":"同じリビジョンと比較することはできません。","In:":"場所:","Inline RSS":"RSS のインライン","Display a table of contents for a page. Each header or section on the page is listed as a link in the table of contents. Click \\\"Save\\\" now, or click \\\"More options\\\" to edit the properties for the table of contents.":"ページの目次を表示します。ページの各ヘッダやセクションが目次の中にリンクとして一覧表示されます。 \\\"保存\\\" をクリックするか、あるいは、 \\\"オプションを表示\\\" をクリックし、目次のプロパティを編集してください。","Table of Contents":"目次","You must specify a page name":"ページ名を指定してください。","Enter a tag and click \\\"Add tag\\\". The tag will be saved when you save the page.":"タグを入力し ”タグを追加” をクリックしてください。タグはページ保存時に追加されます。","Optional properties include the name of the workspace to search, whether to search in the page title, text or tags, and whether to display full results or just page titles.":"オプショナルプロパティで、検索するワークスペース名、また、ページタイトル、テキスト、タグのうち、どれで検索するのか指定できます。完全検索結果を表示させるか、ページタイトルのみを表示させるかも指定することができます。","Preview":"プレビュー","Add file":"ファイルを追加","Optional properties include specifying which workspace to use and whether to display page titles or whole pages.":"使用するワークスペース、また、ページのタイトルを表示させるか、ページ全体を表示させるか、オプショナルプロパティで指定できます。","Expand zip archives and attach individual files to the page?":"zip アーカイブを解凍し、個々のファイルをページに添付しますか？","RSS feed URL:":"RSS フィード URL:","No tag entered":"タグが入力されていません。","error -> To send email, you must specify a recipient":"エラー -> Email を送るには宛先を指定してください。","Heading 5":"見出し5","Advanced content is shown inside a grey border. Switch to %1 to edit areas inside a grey border.":"灰色の点線ボックス内の内容は高度編集モードでのみ編集可能です。ボックス内を編集するには %1 に切り替えてください。","Filename is too long after URL encoding.":"URL のエンコード処理を行うと、ファイル名が長くなりすぎます","Optional properties include specifying a different page for the attachment, and link text.":"オプショナルプロパティで、添付するページ、リンクの文字を指定できます。","Could not remove page from watchlist":"ウォッチリストからページを削除することができませんでした。","Uploaded files:":"アップロードされたファイル:","Display the results from a Google search. Use this form to edit the properties for the search.":"Google による検索結果を表示します。このフォームを使用して検索のプロパティを編集してください。フォームには検索したいワードを入力します。","Display the contents of another page within the current page. Use this form to edit the properties for the page include.":"現在のページの中に、別のページの内容を表示します。このフォームを使用して挿入するページのプロパティを編集してください。","Skype Link":"Skype リンク","Unlink":"リンクをはずす","There are no optional properties for unformatted text.":"レイアウトなしのテキストに関するオプショナルプロパティはありません。","Optional properties include the title of another page to which the image is attached, and link text. If link text is specified then a link to the image is displayed instead of the image.":"オプショナルプロパティで、画像が添付されている別のページの名前、リンクの文字を指定できます。リンクの文字が指定されている場合は、画像ではなく、画像へのリンクが表示されます。","Heading 1":"見出し1","Search term:":"検索するワード:","Upload file":"ファイルのアップロード","Unformatted":"レイアウトなしテキスト","Could not add page to watchlist":"ウォッチリストにページを追加することができませんでした。","Atom feed URL:":"Atom フィード URL:","There are no optional properties for page include.":"ページ挿入に関するオプショナルプロパティはありません。","Optional properties include the text to display for the link, and a target section within the linked page.":"オプショナルプロパティで、リンクの文字、リンク先のセクションを指定できます。","Add another tag":"別のタグを追加","Add another file":"別のファイルを追加","selection_start: %1":"selection_start: %1","Unselect all pages":"すべてのページの選択を解除","Insert table":"表を挿入","page does not exist":"ページが存在しません。","Display a link to an AIM screen name. The icon will show whether the person is online. Clicking the link will start an IM conversation with the person if your IM client is properly configured. Use this form to edit the properties of the link.":"AIM スクリーンネームへのリンクを表示します。相手がオンラインかどうかアイコンで表示されます。 IM クライアントがきちんと設定されていれば、リンクをクリックすると IM で会話を開始することができます。このフォームを使用してリンクのプロパティを編集してください。","There are no optional properties for an Google search.":"Google 検索に関するオプショナルプロパティはありません。","Text":"テキスト","Underline":"下線","Headers and<br/>sections in:":"見出しと<br/>セクション:","Section name:":"セクション名:","Bulleted List":"箇条書き","Weblog Link":"ウェブログリンク","Unformatted content:":"レイアウトなしテキスト:","Date in Local Time":"ローカルタイム","Adding tag %1":"タグ %1 を追加しています","Click \\\"Browse\\\" to find the file you want to upload. When you click \\\"Upload another file\\\" your file will be uploaded and added to the list of attachments for this page.":"\\\"参照\\\"をクリックし、アップロードしたいファイルを選択してください。 \\\"別のファイルのアップロード\\\" をクリックすると、そのファイルがアップロードされ、このページの添付リストに追加されます。","Tag":"タグ","Could not remove tag":"タグを削除できませんでした。","Display an image on this page. The image must be already uploaded as an attachment to this page or another page. Use this form to edit the properties of the displayed image.":"このページに画像を表示します。画像は添付として、このページ、あるいは、別のページにすでにアップロードされているはずです。このフォームを使用して表示された画像のプロパティを編集してください。","Italic":"イタリック","You must select two revisions to compare.":"比較したいリビジョンを2つ選択してください。","User's email:":"ユーザの Email:","Enter your destination url here:":"ここにリンクしたいサイトの URL を入力してください。","Weblog on:":"ウェブログ","External Link":"外部リンクの作成","Save":"保存","Use %1 to change the number of rows and columns in a table.":"%1 を使用して、表の行数と列数を変更してください。","in:":"場所","the workspace named":"別のワークスペース","Display a link to a Skype name. Clicking the link will start a Skype call with the person if your Skype client is properly configured. Use this form to edit the properties of the link.":"Skype 名へのリンクを表示します。 Skype クライアントがきちんと設定されていれば、リンクをクリックすると Skype 通話が開始されます。このフォームを使用してリンクのプロパティを編集してください。","You must check at least one page in order to create a Word document.":"Word文書を生成するためには少なくとも一つのページをチェックしなければいけません。","'%1' is a required field":"'%1' は必要な項目です","Insert...":"挿入 ...","Title":"タイトル","Tag List":"タグ一覧","Other workspace:":"別のワークスペース","error -> \\\"%1\\\" is not a valid email address":"エラー -> \\\"%1\\\" は有効な Email アドレスではありません。","Yahoo! IM Link":"Yahoo! IM リンク","This is not an editable widget. Please edit it in advanced mode.":"この widget は編集できません。高度編集モードで編集してください。","Insert attachment":"添付の挿入","Uploading %1...":"%1 をアップロード中...","That seems like a bit too large for a table.":"表にしては少し大きすぎるようです。","the current page":"現在のページ","Tag Link":"タグリンク","Increase Indent":"インデントを増やす","%asis_content":"(オプショナル)","There are no optional properties for an AIM link.":"AIM リンクに関するオプショナルプロパティはありません。","Untitled Page":"タイトルなし","Advanced Content in Grey Border":"高度編集モードの編集内容を灰色の点線ボックス内に表示","[Style]":"スタイル","Display a list of pages recently changed in a workspace. By default only the page titles are displayed. Use this form to edit the list properties.":"ワークスペースで最近変更があったページの一覧を表示します。初期設定では、ページのタイトルのみが表示されます。このフォームを使用してリストのプロパティを編集してください。","Horizontal Rule":"水平線","Click \\\"Browse\\\" to find the file you want to upload. When you click \\\"Add file,\\\" this file will be added to the list of attachments for this page, and uploaded when you save the page.":"\\\"参照\\\"をクリックし、アップロードしたいファイルを選択してください。\\\"ファイルを追加\\\" をクリックすると、このファイルがこのページの添付リストに追加され、ページを保存した時にアップロードされます。","Heading 3":"見出し3","Please enter the number of table rows:":"表の行の数字を入力してください:","Fewer options":"オプション >>","type link text here":"ここにリンクの文字をタイプしてください。","Strikethrough":"取り消し線","Bold":"太字","Unexpected Widget >>%1<< in parseWidget":"parseWidget で予期しない Widget >>%1<<","You have unsaved changes. Do you want to save those changes? If you click 'OK', all edit changes will be lost. Click 'Cancel' if you want to save changes before navigating away from this page.":"変更が保存されていません。 変更を破棄しますか？ 'OK' をクリックすると、すべての変更内容が失われます。このページから離れる前に変更を保存する場合は、'キャンセル' をクリックしてください。","\\\",\\\"":"\\\",\\\"","Files To upload:":"アップロードするファイル:","Numbering":"番号付き箇条書き","Display a list of the most recently changed pages in a workspace that have a specific tag. By default only the page title is displayed. Use this form to edit the list properties.":"特定のタグが付いているワークスペースで、最も最近変更のあったページ一覧を表示します。初期設定では、ページのタイトルのみが表示されます。このフォームを使用してリストのプロパティを編集してください。","Click \\\"Browse\\\" to find the file you want to upload. When you click \\\"Add another file,\\\" these files will be added to the list of attachments for this page, and uploaded when you save the page.":"\\\"参照\\\" をクリックし、アップロードしたいファイルを選択してください。 \\\"別のファイルを追加\\\" をクリックすると、これらのファイルがこのページの添付リストに追加され、ページを保存した時にアップロードされます。","Heading 2":"見出し2","Weblog name:":"ウェブログ名:","Add a link to this attachment at the top of the page? Images will appear in the page.":"このページのトップにある添付にリンクを追加しますか？ 添付ファイルが画像の場合は、画像がページ内に表示されます。","Please select the text you would like to turn into a link.":"リンクに変換したいテキストを選択してください。","There are no optional properties for a Yahoo! link.":"Yahoo! リンクに関するオプショナルプロパティはありません。","Search type:":"検索対象:","Display the full name for the given email address or user name. Use this form to edit the properties of the user name.":"与えられた Email アドレス、あるいは、ユーザ名に対してフルネームを表示します。このフォームを使用してユーザ名のプロパティを編集してください。","Plese click \\\"Browse\\\" and select a file to upload.":"\\\"参照\\\" をクリックして、アップロードするファイルを選択してください。","You must check at least one page in order to create a PDF.":"PDFを生成するためには少なくとも一つのページをチェックしなければいけません。","the page titled":"別のページ","Skype name:":"Skype 名:","Select a form and generates a new form page.":"フォームを選択してください。新しいフォームページを作成します。","Include an Image":"画像の挿入","More options":"他のオプション","Create Link":"リンクの作成","More Indented":"インデントを増やす","Display the results for a Technorati search. Use this form to edit the properties for the search.":"Technorati による検索結果を表示します。このフォームを使用して検索のプロパティを編集してください。フォームには検索したいURLを入力します。","Preformatted":"レイアウト表示","Full results:":"内容を表示:","Optional parameters include specifying which workspace to use and whether to display page titles or whole pages.":"使用するワークスペース、また、ページのタイトルを表示させるか、ページ全体を表示させるか、オプショナルパラメーターで指定できます。","Numbered List":"番号付き箇条書き","Insert Socialtext link":"リンクの作成","Images":"画像","Heading 4":"見出し4","Optionally, specify which page's headers and sections to use for the table of contents.":"オプションとして、どのページの見出しとセクションを目次に使用するか指定できます。","You must select one of the options or click cancel":"オプションの中から1つ選択するか、キャンセルをクリックしてください。","Google Search":"Google 検索","Attached to:":"添付:","About Wikiwyg":"Wikiwygにつぃて","Display a link to a Convoq name. Clicking the link will start a Convoq call with the person if your Convoq client is properly configured. Use this form to edit the properties of the Convoq link.":"Convoq 名へのリンクを表示します。Convoq クライアントがきちんと設定されていれば、リンクをクリックすると Convoq コールが開始されます。このフォームを使用してConvoq リンクのプロパティを編集してください。","Convoq name:":"Convoq 名:","Page title:":"ページのタイトル:","Display a link to a weblog. Use this form to edit the properties of the link.":"ウェブログへのリンクを表示します。このフォームを使用してリンクのプロパティを編集してください。","File size exceeds maximum limit. File was not uploaded.":"ファイルサイズが上限を超えています。ファイルをアップロードできませんでした。","Error":"エラー","Section Marker":"セクションマーカー","Yahoo! ID:":"Yahoo! ID:","There are no optional properties for a section marker.":"セクションマーカーに関するオプショナルプロパティはありません。","There are no optional properties for a user name.":"ユーザ名に関するオプショナルプロパティはありません。","That doesn't appear to be a valid number.":"有効な数字のようではありません。","There are no optional properties for a new form page.":"新しいフォームページに関するオプショナルプロパティはありません。","File attached to:":"ファイルの添付先:","Please click browse and select a file to upload.":"参照をクリックし、アップロードするファイルを選択してください。","Remove %1 from the queue":"キューから%1を削除","<span class=\\\"st-tags-nomatch\\\">No matches</span>":"<span class=\\\"st-tags-nomatch\\\">一致するタグがありません。</span>","Please enter the number of table columns:":"表の列の数字を入力してください:","Display the given date and time in the individually-set time zone for each reader. Use this form to edit the date and time to be displayed":"各ユーザが個々に設定したタイムゾーンで日時を表示します。このフォームを使用して表示される日時を編集してください。","Display a link to a Yahoo! instant message ID. The icon will show whether the person is online. Clicking the link will start an IM conversation with the person if your IM client is properly configured. Use this form to edit the properties of the link.":"Yahoo! インスタントメッセージ ID へのリンクを表示します。相手がオンラインかどうかアイコンで表示されます。IM クライアントがきちんと設定されていれば、リンクをクリックすると IM で会話を開始することができます。このフォームを使用してリンクのプロパティを編集してください。","Replace this text with your own.":"このテキストを書き換えてください。","There are no optional properties for a date display.":"日時の表示に関するオプショナルプロパティはありません。","Include unformatted text in the page. This text will not be treated as wiki text. Use this form to edit the text.":"ページにレイアウトなしのテキストを挿入します。このテキストには wiki 記法が適用されません。このフォームを使用してテキストを編集してください。","the current workspace":"現在のワークスペース","Attachment Link":"添付ファイルへのリンク","Use this form to edit the properties of the link to a page section.":"このフォームを使用してページセクションへのリンクのプロパティを編集してください。","Decrease Indent":"インデントを減らす","Tag name:":"タグ名:","Bullets":"箇条書き","These tags have been removed:":"これらのタグが削除されました:","New search":"ワードを入力","\\\"%1\\\" is a reserved page name. Please use a different name":"\\\"%1\\\" は予約されたページ名です。別の名前を使用してください。","Use this form to edit the properties of the link.":"このフォームを使用してリンクのプロパティを編集してください。「別のワークスペース」にはワークスペース名を入力してください。","Attachments":"添付","Display a list of the most recent entries from a weblog in a workspace. By default only the weblog entry names are displayed. Use this form to edit the list properties.":"ワークスペースのウェブログから、最も最近のエントリ一覧を表示します。初期設定では、ウェブログのエントリ名のみが表示されます。このフォームを使用してリストのプロパティを編集してください。","You have unsaved changes. Are you sure you want to navigate away from this page? If you click 'OK', all edit changes will be lost. Click 'Cancel' if you want to save changes and stay on the current page.":"変更が保存されていません。 このページから離れますか？ 'OK' をクリックすると、すべての変更内容が失われます。変更を保存し、このページに残りたい場合は、'キャンセル' をクリックしてください。","Table & Advanced Editing":"表 & 高度編集","Optional properties include the text to display for the link, and the title of a different page.":"オプショナルプロパティで、リンクの文字、リンク先のページのタイトルを指定できます。","Advanced Mode":"高度編集モード","Link to a Section":"セクションへのリンク","Page Include":"ページの挿入","If you click 'OK', all edit changes will be lost!":"'OK'をクリックすると、すべての編集内容が失われます！","or":"あるいは","Strike Through":"取り消し線","Search for:":"検索:","Removing tag %1":"タグ %1 を削除中","Search:":"検索:","Inter-workspace link":"ワークスペース間のリンク","Select all pages":"すべてのページを選択","Search Results":"検索結果","Link text:":"リンクの文字:","Insert web link":"外部リンクの作成","Add a section marker at the current cursor location. You can link to a section marker using a \\\"Section Link\\\". Use this form to edit the properties for the section marker.":"カーソルが今ある位置にセクションマーカーを追加します。 \\\"セクションリンク\\\" でセクションマーカーへリンクすることができます。このフォームを使用してセクションマーカーのプロパティを編集してください。","Workspace:":"ワークスペース:","Page in:":"ページ:","Are you sure you want to delete this page?":"このページを本当に削除しますか？","Heading 6":"見出し6","Less Indented":"インデントを減らす","Optional properties include link text, and the name of a different workspace for the tags.":"オプショナルプロパティで、リンクの文字、そのタグに対する別のワークスペース名を指定できます。","There are no optional properties for an RSS feed.":"RSS フィードに関するオプショナルプロパティはありません。","Attached Image":"添付画像","Watch this page":"このページをウォッチする","Other page in:":"別のページ:","Insert image":"画像の挿入","YYYY-MM-DD&nbsp;HH:MM:SS:":"YYYY-MM-DD&nbsp;HH:MM:SS:","Page Title required if Workspace Id specified":"ワークスペース ID が指定されている場合は、ページのタイトルが 必要です。","No matches":"一致するページがありません。","Safari does not support simple mode editing":"Safari は簡易編集モードに対応していません。","Expand zip archive and attach individual files to the page?":"zip アーカイブを解凍し、個々のファイルをページに添付しますか？","Add tag":"タグを追加","There are no optional properties for a Technorati search.":"Technorati リンクに関するオプショナルプロパティはありません。","Display the content of an RSS feed. Use this form to edit the properties of the inline RSS feed.":"RSS フィードの内容を表示します。このフォームを使用して インライン RSS フィードのプロパティを編集してください。","Upload another file":"別のファイルのアップロード","AIM screen name:":"AIM スクリーンネーム:","Technorati Search":"Technorati 検索","There are no optional properties for a Skype link.":"Skype リンクに関するオプショナルプロパティはありません。","What's New":"更新情報","Inline Atom":"Atom のインライン","Optional properties include link text, and the name of a different workspace for the weblog.":"オプショナルプロパティには、リンクの文字、ワークスペース名があります。","Watching this page":"このページをウォッチ中","Normal Text":"ノーマルテキスト","Add links to these attachments at the top of the page? Images will appear in the page.":"このページのトップにある添付にリンクを追加しますか？ ページに画像が表示されます。","There are no optional properties for an Atom feed.":"ATOM フィードに関するオプショナルプロパティはありません。","Weblog List":"ウェブログ一覧","Saving...":"保存中...","New Form Page":"新しいフォームページ","AIM Link":"AIM リンク","Form name:":"フォーム名:"},"zj":{"Use Advanced Mode for %1":"うSえ あDvあnCえD MおDえ fおr %1","Could not retrieve the latest revision of the page":"cおうLd nお7 rえ7Rいえvえ 7hえ Lあ7えS7 rえvいsいおN おf 7Hえ pあgえ","Enter a tag and click \\\"Add another tag\\\". The tag will be saved when you save the page.":"えN7えr あ 7あg あNd cLいCk \\\"あDd あNお7hえr 7あg\\\". 7hえ 7あG WいLl 8え SあVえD Whえn yおう sあvえ 7hえ PあGえ.","Convoq Link":"cおnVおQ LいNk","Display the search results for the given phrase within a workspace. Use this form to edit the properties for the search.":"dいsPlあy 7Hえ sえあRcH RえSうL7S FおR 7hえ GいVえN PhRあSえ wい7HいN あ WおRkSpあcえ. うSえ 7HいS FおRm 7お えdい7 7Hえ pRおPえR7いえS FおR 7hえ SえあrCh.","Attachment filename:":"あ77あcHmえn7 FいLえNあMえ:","Pages tagged with":"pあgえs 7あgGえD Wい7h","Switch to %1 to use this feature.":"sWい7cH 7お %1 7お うSえ 7HいS Fえあ7うrえ.","Page title is too long after URL encoding":"pあgえ 7い7lえ いs 7おお lおnG あf7えR うrL えnCおDいNg","Cancel":"cあnCえL","User Name":"うSえR NあMえ","Display the content of an Atom feed. Use this form to edit the properties of the inline Atom feed.":"dいsPlあy 7Hえ cおn7えN7 おF あn あ7おM Fええd. うsえ 7hいs fおrM 7お えDい7 7hえ Prおpえr7いえs おF 7hえ いnLいNえ あ7おM Fええd.","Create Table":"cRえあ7え 7あ8lえ","Requires one of: %1":"rえqういRえS おnえ おf: %1","Link to Attachment":"lいnK 7お あ77あcHmえn7","Can't have a 0 for a size.":"cあn'7 hあvえ あ 0 FおR あ SいZえ.","Optionally, specify that the page contents should be displayed.":"おP7いおNあLlY, sPえCいFy 7Hあ7 7hえ PあGえ cおn7えN7S ShおうLd 8え DいSpLあYえD.","You have unsaved changes. Are you sure you want to navigate away from this page? If you click 'OK', all edit changes will be lost. Click 'Cancel' if you want to stay on the current page.":"yおう hあvえ うnSあVえD ChあnGえS. あRえ yおう sうrえ Yおう WあN7 7お NあVいGあ7え あWあY Frおm 7HいS PあGえ? いf yおう cLいCk 'おk', あLl えDい7 ChあnGえS WいLl 8え LおS7. ClいcK 'cあnCえL' いF Yおう WあN7 7お S7あy おN 7hえ CうRrえn7 PあGえ.","There are no optional properties for a Convoq Link.":"7HえRえ あRえ nお おp7いおnあl pRおPえR7いえS FおR あ CおNvおq lいnK.","Display a link to a file attached to a page. Use this form to edit the properities of the link.":"dいsPlあy あ lいnK 7お あ fいlえ あ77あChえd 7お あ PあGえ. うsえ 7hいs fおrM 7お えDい7 7hえ Prおpえrい7いえS おf 7Hえ lいnK.","Loading...":"lおあDいNg...","wiki text":"wいkい 7えX7","Display a link to a list of pages with a specific tag. Use this form to edit the properties of the link.":"dいsPlあy あ lいnK 7お あ lいs7 おf pあgえs wい7H あ Spえcいfいc 7あg. うsえ 7hいs fおrM 7お えDい7 7hえ Prおpえr7いえs おF 7hえ LいNk.","Click \\\"Browse\\\" to find the file you want to upload. When you click \\\"Upload file\\\" your file will be uploaded and added to the list of attachments for this page.":"cLいCk \\\"8RおWsえ\\\" 7お fいnD 7hえ FいLえ yおう wあn7 7お うPlおあD. wHえN Yおう ClいcK \\\"うpLおあd fいlえ\\\" Yおうr fいlえ WいLl 8え うpLおあdえd あNd あDdえd 7お 7hえ LいS7 おF あ77あChMえN7S FおR 7hいs pあgえ.","Edit More":"えDい7 MおRえ","'%1' has an invalid value":"'%1' HあS あn いNvあlいd vあlうえ","Table Edit Tip":"7あ8Lえ えDい7 7いP","Pages in:":"pあgえs いN:","You cannot compare a revision to itself.":"yおう cあnNお7 CおMpあrえ あ RえVいSいおn 7お い7SえLf.","Inline RSS":"いNlいnえ RsS","In:":"いN:","Display a table of contents for a page. Each header or section on the page is listed as a link in the table of contents. Click \\\"Save\\\" now, or click \\\"More options\\\" to edit the properties for the table of contents.":"dいsPlあy あ 7あ8Lえ おF CおN7えn7s fおr あ pあgえ. えあcH Hえあdえr おR SえC7いおN おn 7Hえ pあgえ いs lいs7えD あs あ lいnK いn 7Hえ 7あ8Lえ おF CおN7えn7s. ClいcK \\\"SあVえ\\\" nおw, おr cLいCk \\\"mおrえ おp7いおnS\\\" 7お えDい7 7hえ Prおpえr7いえs fおr 7Hえ 7あ8Lえ おF CおN7えn7s.","You must specify a page name":"yおう mうs7 SpえcいfY あ PあGえ nあmえ","Table of Contents":"7あ8Lえ おF CおN7えn7s","Enter a tag and click \\\"Add tag\\\". The tag will be saved when you save the page.":"えN7えr あ 7あg あNd cLいCk \\\"あDd 7あg\\\". 7hえ 7あG WいLl 8え SあVえD Whえn yおう sあvえ 7hえ PあGえ.","Optional properties include the name of the workspace to search, whether to search in the page title, text or tags, and whether to display full results or just page titles.":"おP7いおNあL Prおpえr7いえs いNcLうDえ 7Hえ nあmえ おf 7Hえ wおrKsPあCえ 7お SえあrCh, Whえ7HえR 7お sえあRcH いn 7Hえ pあgえ 7い7lえ, 7えx7 おr 7あgS, あNd wHえ7hえr 7お DいSpLあY FうLl rえsうl7s おR JうS7 pあgえ 7い7lえs.","Preview":"pRえVいえw","Add file":"あDd fいlえ","Optional properties include specifying which workspace to use and whether to display page titles or whole pages.":"おP7いおNあL Prおpえr7いえs いNcLうDえ sPえCいFyいnG WhいcH WおRkSpあcえ 7お うSえ あNd wHえ7hえr 7お DいSpLあY PあGえ 7い7LえS おr wHおLえ pあgえs.","Expand zip archives and attach individual files to the page?":"えXpあnD ZいP あrChいvえs あNd あ77あcH いnDいVいDうあl fいlえs 7お 7hえ PあGえ?","RSS feed URL:":"rSs fええD うrL:","No tag entered":"nお 7あG えn7えRえD","error -> To send email, you must specify a recipient":"えRrおr -> 7お sえnD えmあいL, yおう mうs7 SpえcいfY あ RえCいPいえn7","Heading 5":"hえあDいNg 5","Advanced content is shown inside a grey border. Switch to %1 to edit areas inside a grey border.":"あDvあnCえD CおN7えn7 いs sHおWn いNsいdえ あ Grえy 8おrDえR. sWい7cH 7お %1 7お えDい7 あrえあS いnSいDえ あ gRえY 8おRdえr.","Filename is too long after URL encoding.":"fいlえnあmえ いs 7おお lおnG あf7えR うrL えnCおDいNg.","Optional properties include specifying a different page for the attachment, and link text.":"おP7いおNあL Prおpえr7いえs いNcLうDえ sPえCいFyいnG あ DいFfえrえn7 PあGえ fおr 7Hえ あ77あcHmえn7, あNd lいnK 7えX7.","Could not remove page from watchlist":"cおうLd nお7 rえmおvえ PあGえ fRおM Wあ7cHlいs7","Uploaded files:":"うPlおあDえD FいLえS:","Display the results from a Google search. Use this form to edit the properties for the search.":"dいsPlあy 7Hえ rえsうl7s fRおM あ GおおgLえ sえあRcH. うSえ 7HいS FおRm 7お えdい7 7Hえ pRおPえR7いえS FおR 7hえ SえあrCh.","Display the contents of another page within the current page. Use this form to edit the properties for the page include.":"dいsPlあy 7Hえ cおn7えN7S おf あNお7hえr pあgえ Wい7hいn 7Hえ cうrRえN7 pあgえ. うSえ 7HいS FおRm 7お えdい7 7Hえ pRおPえR7いえS FおR 7hえ PあGえ いNcLうDえ.","Skype Link":"sKyPえ lいnK","Unlink":"うNlいnK","There are no optional properties for unformatted text.":"7HえRえ あRえ nお おp7いおnあl pRおPえR7いえS FおR うnFおRmあ77えD 7えX7.","Optional properties include the title of another page to which the image is attached, and link text. If link text is specified then a link to the image is displayed instead of the image.":"おP7いおNあL Prおpえr7いえs いNcLうDえ 7Hえ 7い7Lえ おF あnお7HえR PあGえ 7お WhいcH 7hえ いmあgえ いs あ77あcHえD, あNd lいnK 7えX7. いf lいnK 7えX7 いS SpえcいfいえD 7hえn あ lいnK 7お 7Hえ いMあGえ いS DいSpLあYえD いnS7えあD おf 7Hえ いMあGえ.","Heading 1":"hえあDいNg 1","Search term:":"sえあRcH 7えRm:","Upload file":"うPlおあD FいLえ","Unformatted":"うNfおrMあ77えd","Could not add page to watchlist":"cおうLd nお7 あDd pあgえ 7お wあ7ChLいS7","Atom feed URL:":"あ7おM Fええd うRl:","There are no optional properties for page include.":"7HえRえ あRえ nお おp7いおnあl pRおPえR7いえS FおR PあGえ いNcLうDえ.","Optional properties include the text to display for the link, and a target section within the linked page.":"おP7いおNあL Prおpえr7いえs いNcLうDえ 7Hえ 7えx7 7お dいsPlあy fおr 7Hえ lいnK, あNd あ 7あrGえ7 SえC7いおN Wい7hいn 7Hえ lいnKえD PあGえ.","Add another tag":"あDd あNお7hえr 7あg","Add another file":"あDd あNお7hえr fいlえ","selection_start: %1":"sえlえc7いおn_s7あR7: %1","Unselect all pages":"うNsえlえc7 あlL PあGえS","Insert table":"いNsえr7 7あ8lえ","page does not exist":"pあgえ Dおえs nお7 えXいS7","Display a link to an AIM screen name. The icon will show whether the person is online. Clicking the link will start an IM conversation with the person if your IM client is properly configured. Use this form to edit the properties of the link.":"dいsPlあy あ lいnK 7お あN あいM ScRええn nあmえ. 7Hえ いCおN WいLl sHおW Whえ7HえR 7hえ PえRsおn いS おnLいNえ. ClいcKいNg 7Hえ lいnK WいLl s7あR7 あN いm cおnVえRsあ7いおN Wい7h 7Hえ pえrSおN いf yおうR いm cLいえn7 いs pRおPえRlY CおNfいgうrえd. うsえ 7hいs fおrM 7お えDい7 7hえ Prおpえr7いえs おF 7hえ LいNk.","There are no optional properties for an Google search.":"7HえRえ あRえ nお おp7いおnあl pRおPえR7いえS FおR あn gおおGlえ SえあrCh.","Text":"7えx7","Underline":"うNdえrLいNえ","Headers and<br/>sections in:":"hえあDえRs あNd<8R/>sえc7いおnS いn:","Section name:":"sえc7いおn nあmえ:","Bulleted List":"8うlLえ7えD LいS7","Weblog Link":"wえ8LおG LいNk","Unformatted content:":"うNfおrMあ77えd cおn7えN7:","Date in Local Time":"dあ7え いn lおcあl 7いmえ","Adding tag %1":"あDdいnG 7あG %1","Click \\\"Browse\\\" to find the file you want to upload. When you click \\\"Upload another file\\\" your file will be uploaded and added to the list of attachments for this page.":"cLいCk \\\"8RおWsえ\\\" 7お fいnD 7hえ FいLえ yおう wあn7 7お うPlおあD. wHえN Yおう ClいcK \\\"うpLおあd あNお7hえr fいlえ\\\" Yおうr fいlえ WいLl 8え うpLおあdえd あNd あDdえd 7お 7hえ LいS7 おF あ77あChMえN7S FおR 7hいs pあgえ.","Tag":"7あg","Could not remove tag":"cおうLd nお7 rえmおvえ 7あG","Display an image on this page. The image must be already uploaded as an attachment to this page or another page. Use this form to edit the properties of the displayed image.":"dいsPlあy あN いmあgえ おn 7HいS PあGえ. 7hえ いmあgえ MうS7 8え あlRえあdY うpLおあdえd あS あn あ77あcHmえn7 7お 7HいS PあGえ おR あnお7HえR PあGえ. うsえ 7hいs fおrM 7お えDい7 7hえ Prおpえr7いえs おF 7hえ DいSpLあYえD いmあgえ.","Italic":"い7あLいC","You must select two revisions to compare.":"yおう mうs7 SえLえC7 7Wお rえvいsいおNs 7お CおMpあrえ.","User's email:":"うSえR'S えmあいL:","Enter your destination url here:":"えN7えr yおうR DえS7いnあ7いおN うrL HえRえ:","Weblog on:":"wえ8LおG おn:","External Link":"えX7えrNあL LいNk","Save":"sあvえ","Use %1 to change the number of rows and columns in a table.":"うSえ %1 7お cHあNgえ 7hえ NうM8えr おF RおWs あNd cおlうmNs いN あ 7あ8lえ.","in:":"いN:","the workspace named":"7Hえ wおrKsPあCえ nあmえd","Display a link to a Skype name. Clicking the link will start a Skype call with the person if your Skype client is properly configured. Use this form to edit the properties of the link.":"dいsPlあy あ lいnK 7お あ sKyPえ nあmえ. cLいCkいnG 7hえ LいNk wいlL S7あr7 あ SkYpえ CあLl wい7H 7hえ PえRsおn いF Yおうr sKyPえ cLいえn7 いs pRおPえRlY CおNfいgうrえd. うsえ 7hいs fおrM 7お えDい7 7hえ Prおpえr7いえs おF 7hえ LいNk.","You must check at least one page in order to create a Word document.":"yおう mうs7 ChえcK あ7 lえあS7 おNえ pあgえ いn おRdえr 7お Crえあ7え あ wおrD DおCうMえN7.","'%1' is a required field":"'%1' いs あ rえqういRえD FいえlD","Insert...":"いNsえr7...","Title":"7い7Lえ","Tag List":"7あg lいs7","Other workspace:":"お7hえr wおrKsPあCえ:","error -> \\\"%1\\\" is not a valid email address":"えRrおr -> \\\"%1\\\" いS Nお7 あ VあLいD えmあいL あdDrえsS","Yahoo! IM Link":"yあhおお! いm lいnK","This is not an editable widget. Please edit it in advanced mode.":"7HいS いs nお7 あN えdい7あ8Lえ wいdGえ7. pLえあsえ えdい7 い7 いn あDvあnCえD MおDえ.","Insert attachment":"いNsえr7 あ77あChMえN7","Uploading %1...":"うPlおあDいNg %1...","That seems like a bit too large for a table.":"7Hあ7 SええmS LいKえ あ 8い7 7おお lあrGえ fおr あ 7あ8Lえ.","the current page":"7Hえ cうrRえN7 pあgえ","Tag Link":"7あg lいnK","Increase Indent":"いNcRえあsえ いnDえN7","%asis_content":"%あsいs_cおn7えN7","There are no optional properties for an AIM link.":"7HえRえ あRえ nお おp7いおnあl pRおPえR7いえS FおR あn あいm lいnK.","Untitled Page":"うN7い7LえD PあGえ","Advanced Content in Grey Border":"あDvあnCえD CおN7えn7 いn gRえY 8おRdえr","[Style]":"[S7Ylえ]","Display a list of pages recently changed in a workspace. By default only the page titles are displayed. Use this form to edit the list properties.":"dいsPlあy あ lいs7 おf pあgえs rえcえn7lY ChあnGえD いn あ wおrKsPあCえ. 8y dえfあうL7 おNlY 7hえ PあGえ 7い7LえS あrえ DいSpLあYえD. うSえ 7HいS FおRm 7お えdい7 7Hえ lいs7 Prおpえr7いえs.","Horizontal Rule":"hおrいzおn7あL RうLえ","Click \\\"Browse\\\" to find the file you want to upload. When you click \\\"Add file,\\\" this file will be added to the list of attachments for this page, and uploaded when you save the page.":"cLいCk \\\"8RおWsえ\\\" 7お fいnD 7hえ FいLえ yおう wあn7 7お うPlおあD. wHえN Yおう ClいcK \\\"あdD FいLえ,\\\" 7hいs fいlえ WいLl 8え あdDえD 7お 7Hえ lいs7 おf あ77あcHmえn7s fおr 7HいS PあGえ, あnD うpLおあdえd wHえN Yおう SあVえ 7Hえ pあgえ.","Heading 3":"hえあDいNg 3","Please enter the number of table rows:":"pLえあsえ えn7えR 7hえ NうM8えr おF 7あ8lえ RおWs:","Fewer options":"fえwえr おP7いおNs","type link text here":"7Ypえ LいNk 7えx7 HえRえ","Strikethrough":"s7rいkえ7HrおうGh","Bold":"8おlD","Unexpected Widget >>%1<< in parseWidget":"うNえXpえc7えD WいDgえ7 >>%1<< いn pあrSえWいDgえ7","You have unsaved changes. Do you want to save those changes? If you click 'OK', all edit changes will be lost. Click 'Cancel' if you want to save changes before navigating away from this page.":"yおう hあvえ うnSあVえD ChあnGえS. dお Yおう WあN7 7お SあVえ 7HおSえ cHあNgえs? いf yおう cLいCk 'おk', あLl えDい7 ChあnGえS WいLl 8え LおS7. ClいcK 'cあnCえL' いF Yおう WあN7 7お SあVえ cHあNgえs 8えfおrえ NあVいGあ7いNg あWあY Frおm 7HいS PあGえ.","\\\",\\\"":"\\\",\\\"","Numbering":"nうm8えRいNg","Files To upload:":"fいlえs 7お うpLおあd:","Display a list of the most recently changed pages in a workspace that have a specific tag. By default only the page title is displayed. Use this form to edit the list properties.":"dいsPlあy あ lいs7 おf 7Hえ mおs7 RえCえN7Ly cHあNgえd pあgえs いN あ WおRkSpあcえ 7hあ7 hあvえ あ Spえcいfいc 7あg. 8y dえfあうL7 おNlY 7hえ PあGえ 7い7Lえ いS DいSpLあYえD. うSえ 7HいS FおRm 7お えdい7 7Hえ lいs7 Prおpえr7いえs.","Click \\\"Browse\\\" to find the file you want to upload. When you click \\\"Add another file,\\\" these files will be added to the list of attachments for this page, and uploaded when you save the page.":"cLいCk \\\"8RおWsえ\\\" 7お fいnD 7hえ FいLえ yおう wあn7 7お うPlおあD. wHえN Yおう ClいcK \\\"あdD あnお7HえR FいLえ,\\\" 7hえsえ FいLえS WいLl 8え あdDえD 7お 7Hえ lいs7 おf あ77あcHmえn7s fおr 7HいS PあGえ, あnD うpLおあdえd wHえN Yおう SあVえ 7Hえ pあgえ.","Heading 2":"hえあDいNg 2","Weblog name:":"wえ8LおG NあMえ:","Add a link to this attachment at the top of the page? Images will appear in the page.":"あDd あ lいnK 7お 7HいS あ77あChMえN7 あ7 7hえ 7おP おf 7Hえ pあgえ? いMあGえS WいLl あPpえあR いn 7Hえ pあgえ.","Please select the text you would like to turn into a link.":"pLえあsえ SえLえC7 7Hえ 7えx7 Yおう WおうlD LいKえ 7お 7うRn いN7お あ LいNk.","There are no optional properties for a Yahoo! link.":"7HえRえ あRえ nお おp7いおnあl pRおPえR7いえS FおR あ YあHおお! lいnK.","Search type:":"sえあRcH 7yPえ:","Display the full name for the given email address or user name. Use this form to edit the properties of the user name.":"dいsPlあy 7Hえ fうlL NあMえ fおr 7Hえ gいvえn えMあいl あDdRえSs おR うsえr nあmえ. うSえ 7HいS FおRm 7お えdい7 7Hえ pRおPえR7いえS おf 7Hえ うSえR NあMえ.","Plese click \\\"Browse\\\" and select a file to upload.":"pLえSえ cLいCk \\\"8RおWsえ\\\" あnD SえLえC7 あ fいlえ 7お うPlおあD.","You must check at least one page in order to create a PDF.":"yおう mうs7 ChえcK あ7 lえあS7 おNえ pあgえ いn おRdえr 7お Crえあ7え あ pDf.","the page titled":"7Hえ pあgえ 7い7lえd","Skype name:":"sKyPえ nあmえ:","Select a form and generates a new form page.":"sえlえc7 あ FおRm あNd gえnえrあ7えs あ nえw fおrM PあGえ.","Include an Image":"いNcLうDえ あN いmあgえ","More options":"mおrえ おp7いおnS","Create Link":"cRえあ7え LいNk","More Indented":"mおrえ いnDえN7えd","Display the results for a Technorati search. Use this form to edit the properties for the search.":"dいsPlあy 7Hえ rえsうl7s fおr あ 7えcHnおrあ7い SえあrCh. うsえ 7hいs fおrM 7お えDい7 7hえ Prおpえr7いえs fおr 7Hえ sえあRcH.","Preformatted":"pRえFおRmあ77えD","Full results:":"fうlL RえSうL7S:","Optional parameters include specifying which workspace to use and whether to display page titles or whole pages.":"おP7いおNあL PあRあMえ7えRs いNcLうDえ sPえCいFyいnG WhいcH WおRkSpあcえ 7お うSえ あNd wHえ7hえr 7お DいSpLあY PあGえ 7い7LえS おr wHおLえ pあgえs.","Numbered List":"nうm8えRえD LいS7","Insert Socialtext link":"いNsえr7 SおCいあl7えX7 lいnK","Images":"いMあGえS","Heading 4":"hえあDいNg 4","Optionally, specify which page's headers and sections to use for the table of contents.":"おP7いおNあLlY, sPえCいFy wHいCh pあgえ'S HえあdえrS あnD SえC7いおNs 7お うsえ FおR 7hえ 7あ8lえ おf cおn7えN7S.","You must select one of the options or click cancel":"yおう mうs7 SえLえC7 おNえ おF 7hえ おp7いおnS おr cLいCk cあnCえL","Google Search":"gおおGlえ SえあrCh","Attached to:":"あ77あcHえD 7お:","About Wikiwyg":"あ8おう7 wいkいwYg","Display a link to a Convoq name. Clicking the link will start a Convoq call with the person if your Convoq client is properly configured. Use this form to edit the properties of the Convoq link.":"dいsPlあy あ lいnK 7お あ cおnVおQ NあMえ. ClいcKいNg 7Hえ lいnK WいLl s7あR7 あ cおnVおQ CあLl wい7H 7hえ PえRsおn いF Yおうr cおnVおQ ClいえN7 いS PrおpえrLy cおnFいGうRえD. うSえ 7HいS FおRm 7お えdい7 7Hえ pRおPえR7いえS おf 7Hえ cおnVおQ LいNk.","Convoq name:":"cおnVおQ NあMえ:","Page title:":"pあgえ 7い7lえ:","Display a link to a weblog. Use this form to edit the properties of the link.":"dいsPlあy あ lいnK 7お あ wえ8LおG. うSえ 7HいS FおRm 7お えdい7 7Hえ pRおPえR7いえS おf 7Hえ lいnK.","File size exceeds maximum limit. File was not uploaded.":"fいlえ SいZえ えXcええDs mあxいmうm lいmい7. FいLえ wあs nお7 うPlおあDえD.","Error":"えRrおr","Section Marker":"sえc7いおn mあrKえR","Yahoo! ID:":"yあhおお! いd:","There are no optional properties for a section marker.":"7HえRえ あRえ nお おp7いおnあl pRおPえR7いえS FおR あ SえC7いおN MあRkえr.","There are no optional properties for a user name.":"7HえRえ あRえ nお おp7いおnあl pRおPえR7いえS FおR あ うsえr nあmえ.","That doesn't appear to be a valid number.":"7Hあ7 DおえsN'7 あpPえあr 7お 8え あ vあlいd nうm8えR.","There are no optional properties for a new form page.":"7HえRえ あRえ nお おp7いおnあl pRおPえR7いえS FおR あ NえW FおRm pあgえ.","File attached to:":"fいlえ あ77あChえd 7お:","Please click browse and select a file to upload.":"pLえあsえ ClいcK 8rおwSえ あNd sえlえc7 あ FいLえ 7お うpLおあd.","Remove %1 from the queue":"rえmおvえ %1 fRおM 7hえ Qうえうえ","<span class=\\\"st-tags-nomatch\\\">No matches</span>":"<Spあn cLあSs=\\\"s7-7あGs-nおmあ7Ch\\\">nお Mあ7cHえS</sPあN>","Please enter the number of table columns:":"pLえあsえ えn7えR 7hえ NうM8えr おF 7あ8lえ CおLうMnS:","Display the given date and time in the individually-set time zone for each reader. Use this form to edit the date and time to be displayed":"dいsPlあy 7Hえ gいvえn dあ7え あnD 7いMえ いN 7hえ いnDいVいDうあlLy-sえ7 7いmえ ZおNえ fおr えあcH Rえあdえr. うsえ 7hいs fおrM 7お えDい7 7hえ Dあ7え あNd 7いmえ 7お 8え DいSpLあYえD","Display a link to a Yahoo! instant message ID. The icon will show whether the person is online. Clicking the link will start an IM conversation with the person if your IM client is properly configured. Use this form to edit the properties of the link.":"dいsPlあy あ lいnK 7お あ yあhおお! いnS7あn7 MえSsあgえ いd. 7hえ いcおn wいlL Shおw wHえ7hえr 7Hえ pえrSおN いs おNlいnえ. cLいCkいnG 7hえ LいNk wいlL S7あr7 あn いM CおNvえrSあ7いおn wい7H 7hえ PえRsおn いF Yおうr いM ClいえN7 いS PrおpえrLy cおnFいGうRえD. うSえ 7HいS FおRm 7お えdい7 7Hえ pRおPえR7いえS おf 7Hえ lいnK.","Replace this text with your own.":"rえpLあCえ 7HいS 7えX7 wい7H Yおうr おWn.","There are no optional properties for a date display.":"7HえRえ あRえ nお おp7いおnあl pRおPえR7いえS FおR あ Dあ7え dいsPlあy.","Include unformatted text in the page. This text will not be treated as wiki text. Use this form to edit the text.":"いNcLうDえ うNfおrMあ77えd 7えx7 いn 7Hえ pあgえ. 7HいS 7えX7 wいlL Nお7 8え 7Rえあ7えd あS WいKい 7えx7. うSえ 7HいS FおRm 7お えdい7 7Hえ 7えx7.","the current workspace":"7Hえ cうrRえN7 wおrKsPあCえ","Attachment Link":"あ77あcHmえn7 LいNk","Use this form to edit the properties of the link to a page section.":"うSえ 7HいS FおRm 7お えdい7 7Hえ pRおPえR7いえS おf 7Hえ lいnK 7お あ pあgえ SえC7いおN.","Decrease Indent":"dえcRえあsえ いnDえN7","Tag name:":"7あg nあmえ:","Bullets":"8うlLえ7s","These tags have been removed:":"7HえSえ 7あgS HあVえ 8ええN RえMおVえD:","New search":"nえw sえあRcH","\\\"%1\\\" is a reserved page name. Please use a different name":"\\\"%1\\\" いs あ rえsえrVえD PあGえ nあmえ. pLえあsえ うsえ あ DいFfえrえn7 NあMえ","Use this form to edit the properties of the link.":"うSえ 7HいS FおRm 7お えdい7 7Hえ pRおPえR7いえS おf 7Hえ lいnK.","Attachments":"あ77あcHmえn7s","Display a list of the most recent entries from a weblog in a workspace. By default only the weblog entry names are displayed. Use this form to edit the list properties.":"dいsPlあy あ lいs7 おf 7Hえ mおs7 RえCえN7 えN7Rいえs fRおM あ Wえ8lおg いN あ WおRkSpあcえ. 8Y DえFあうl7 おnLy 7Hえ wえ8LおG えn7rY NあMえS あrえ DいSpLあYえD. うSえ 7HいS FおRm 7お えdい7 7Hえ lいs7 Prおpえr7いえs.","You have unsaved changes. Are you sure you want to navigate away from this page? If you click 'OK', all edit changes will be lost. Click 'Cancel' if you want to save changes and stay on the current page.":"yおう hあvえ うnSあVえD ChあnGえS. あRえ yおう sうrえ Yおう WあN7 7お NあVいGあ7え あWあY Frおm 7HいS PあGえ? いf yおう cLいCk 'おk', あLl えDい7 ChあnGえS WいLl 8え LおS7. ClいcK 'cあnCえL' いF Yおう WあN7 7お SあVえ cHあNgえs あNd s7あY おn 7Hえ cうrRえN7 pあgえ.","Table & Advanced Editing":"7あ8Lえ & あDvあnCえD えdい7いnG","Optional properties include the text to display for the link, and the title of a different page.":"おP7いおNあL Prおpえr7いえs いNcLうDえ 7Hえ 7えx7 7お dいsPlあy fおr 7Hえ lいnK, あNd 7Hえ 7い7Lえ おF あ DいFfえrえn7 PあGえ.","Advanced Mode":"あDvあnCえD MおDえ","Link to a Section":"lいnK 7お あ sえc7いおn","Page Include":"pあgえ いnClうdえ","If you click 'OK', all edit changes will be lost!":"いF Yおう ClいcK 'おK', あlL えdい7 cHあNgえs wいlL 8え lおs7!","or":"おR","Strike Through":"s7rいkえ 7hRおうgH","Search for:":"sえあRcH FおR:","Removing tag %1":"rえmおvいnG 7あG %1","Search:":"sえあRcH:","Inter-workspace link":"いN7えr-wおrKsPあCえ lいnK","Select all pages":"sえlえc7 あlL PあGえS","Search Results":"sえあRcH RえSうL7S","Link text:":"lいnK 7えX7:","Insert web link":"いNsえr7 Wえ8 LいNk","Add a section marker at the current cursor location. You can link to a section marker using a \\\"Section Link\\\". Use this form to edit the properties for the section marker.":"あDd あ sえc7いおn mあrKえR あ7 7Hえ cうrRえN7 cうrSおR LおCあ7いおn. Yおう CあN LいNk 7お あ SえC7いおN MあRkえr うSいNg あ \\\"sえc7いおn lいnK\\\". うSえ 7HいS FおRm 7お えdい7 7Hえ pRおPえR7いえS FおR 7hえ SえC7いおN MあRkえr.","Workspace:":"wおrKsPあCえ:","Page in:":"pあgえ いn:","Are you sure you want to delete this page?":"あRえ yおう sうrえ Yおう WあN7 7お DえLえ7え 7HいS PあGえ?","Heading 6":"hえあDいNg 6","Less Indented":"lえsS いnDえN7えd","Optional properties include link text, and the name of a different workspace for the tags.":"おP7いおNあL Prおpえr7いえs いNcLうDえ lいnK 7えX7, あnD 7hえ NあMえ おF あ DいFfえrえn7 WおRkSpあcえ FおR 7hえ 7あGs.","There are no optional properties for an RSS feed.":"7HえRえ あRえ nお おp7いおnあl pRおPえR7いえS FおR あn rSs fええD.","Attached Image":"あ77あcHえD いmあgえ","Watch this page":"wあ7Ch 7HいS PあGえ","Other page in:":"お7hえr pあgえ いn:","Insert image":"いNsえr7 いmあgえ","YYYY-MM-DD&nbsp;HH:MM:SS:":"yYyY-Mm-dD&N8Sp;hH:Mm:sS:","Page Title required if Workspace Id specified":"pあgえ 7い7lえ RえQういrえd いF WおRkSpあcえ いd sPえCいFいえd","No matches":"nお Mあ7cHえS","Safari does not support simple mode editing":"sあfあrい Dおえs nお7 sうpPおR7 sいmPlえ MおDえ えDい7いNg","Expand zip archive and attach individual files to the page?":"えXpあnD ZいP あrChいvえ あnD あ77あCh いNdいvいdうあL FいLえS 7お 7Hえ pあgえ?","Add tag":"あDd 7あg","There are no optional properties for a Technorati search.":"7HえRえ あRえ nお おp7いおnあl pRおPえR7いえS FおR あ 7えChNおRあ7い sえあRcH.","Display the content of an RSS feed. Use this form to edit the properties of the inline RSS feed.":"dいsPlあy 7Hえ cおn7えN7 おF あn rSs fええD. うSえ 7HいS FおRm 7お えdい7 7Hえ pRおPえR7いえS おf 7Hえ いNlいnえ RsS Fええd.","Upload another file":"うPlおあD あnお7HえR FいLえ","AIM screen name:":"あいm sCrええN NあMえ:","Technorati Search":"7えcHnおrあ7い SえあrCh","There are no optional properties for a Skype link.":"7HえRえ あRえ nお おp7いおnあl pRおPえR7いえS FおR あ SkYpえ LいNk.","What's New":"wHあ7'S NえW","Inline Atom":"いNlいnえ あ7おm","Optional properties include link text, and the name of a different workspace for the weblog.":"おP7いおNあL Prおpえr7いえs いNcLうDえ lいnK 7えX7, あnD 7hえ NあMえ おF あ DいFfえrえn7 WおRkSpあcえ FおR 7hえ Wえ8lおg.","Watching this page":"wあ7ChいnG 7hいs pあgえ","Normal Text":"nおrMあL 7えX7","Add links to these attachments at the top of the page? Images will appear in the page.":"あDd lいnKs 7お 7hえsえ あ77あChMえN7S あ7 7Hえ 7おp おF 7hえ PあGえ? いmあgえs wいlL あpPえあr いN 7hえ PあGえ.","There are no optional properties for an Atom feed.":"7HえRえ あRえ nお おp7いおnあl pRおPえR7いえS FおR あn あ7おM Fええd.","Weblog List":"wえ8LおG LいS7","Saving...":"sあvいnG...","New Form Page":"nえw fおrM PあGえ","AIM Link":"あいm lいnK","Form name:":"fおrM NあMえ:"},"zz":{"Use Advanced Mode for %1":"uS3 4Dv4nC3D M0D3 f0r %1","Could not retrieve the latest revision of the page":"c0uLd n07 r37Ri3v3 7h3 L473S7 r3vIsI0N 0f 7H3 p4g3","Enter a tag and click \\\"Add another tag\\\". The tag will be saved when you save the page.":"3N73r 4 74g 4Nd cLiCk \\\"4Dd 4N07h3r 74g\\\". 7h3 74G WiLl 83 S4V3D Wh3n y0u s4v3 7h3 P4G3.","Convoq Link":"c0nV0Q LiNk","Display the search results for the given phrase within a workspace. Use this form to edit the properties for the search.":"dIsPl4y 7H3 s34RcH R3SuL7S F0R 7h3 GiV3N PhR4S3 wI7HiN 4 W0RkSp4c3. uS3 7HiS F0Rm 70 3dI7 7H3 pR0P3R7I3S F0R 7h3 S34rCh.","Attachment filename:":"4774cHm3n7 FiL3N4M3:","Pages tagged with":"p4g3s 74gG3D Wi7h","Switch to %1 to use this feature.":"sWi7cH 70 %1 70 uS3 7HiS F347Ur3.","Page title is too long after URL encoding":"p4g3 7i7l3 Is 700 l0nG 4f73R UrL 3nC0DiNg","Cancel":"c4nC3L","User Name":"uS3R N4M3","Display the content of an Atom feed. Use this form to edit the properties of the inline Atom feed.":"dIsPl4y 7H3 c0n73N7 0F 4n 470M F33d. Us3 7hIs f0rM 70 3Di7 7h3 Pr0p3r7i3s 0F 7h3 InLiN3 470M F33d.","Create Table":"cR3473 748l3","Requires one of: %1":"r3qUiR3S 0n3 0f: %1","Link to Attachment":"lInK 70 4774cHm3n7","Can't have a 0 for a size.":"c4n'7 h4v3 4 0 F0R 4 SiZ3.","Optionally, specify that the page contents should be displayed.":"0P7I0N4LlY, sP3CiFy 7H47 7h3 P4G3 c0n73N7S Sh0uLd 83 DiSpL4Y3D.","You have unsaved changes. Are you sure you want to navigate away from this page? If you click 'OK', all edit changes will be lost. Click 'Cancel' if you want to stay on the current page.":"y0u h4v3 UnS4V3D Ch4nG3S. 4R3 y0u sUr3 Y0U W4N7 70 N4ViG473 4W4Y Fr0m 7HiS P4G3? If y0u cLiCk '0k', 4Ll 3Di7 Ch4nG3S WiLl 83 L0S7. ClIcK 'c4nC3L' iF Y0U W4N7 70 S74y 0N 7h3 CuRr3n7 P4G3.","There are no optional properties for a Convoq Link.":"7H3R3 4R3 n0 0p7i0n4l pR0P3R7I3S F0R 4 C0Nv0q lInK.","Display a link to a file attached to a page. Use this form to edit the properities of the link.":"dIsPl4y 4 lInK 70 4 fIl3 4774Ch3d 70 4 P4G3. Us3 7hIs f0rM 70 3Di7 7h3 Pr0p3rI7I3S 0f 7H3 lInK.","Loading...":"l04DiNg...","wiki text":"wIkI 73X7","Display a link to a list of pages with a specific tag. Use this form to edit the properties of the link.":"dIsPl4y 4 lInK 70 4 lIs7 0f p4g3s wI7H 4 Sp3cIfIc 74g. Us3 7hIs f0rM 70 3Di7 7h3 Pr0p3r7i3s 0F 7h3 LiNk.","Click \\\"Browse\\\" to find the file you want to upload. When you click \\\"Upload file\\\" your file will be uploaded and added to the list of attachments for this page.":"cLiCk \\\"8R0Ws3\\\" 70 fInD 7h3 FiL3 y0u w4n7 70 uPl04D. wH3N Y0U ClIcK \\\"UpL04d fIl3\\\" Y0Ur fIl3 WiLl 83 UpL04d3d 4Nd 4Dd3d 70 7h3 LiS7 0F 4774ChM3N7S F0R 7hIs p4g3.","Edit More":"3Di7 M0R3","'%1' has an invalid value":"'%1' H4S 4n iNv4lId v4lU3","Table Edit Tip":"748L3 3Di7 7iP","Pages in:":"p4g3s iN:","You cannot compare a revision to itself.":"y0u c4nN07 C0Mp4r3 4 R3ViSi0n 70 I7S3Lf.","Inline RSS":"iNlIn3 RsS","In:":"iN:","Display a table of contents for a page. Each header or section on the page is listed as a link in the table of contents. Click \\\"Save\\\" now, or click \\\"More options\\\" to edit the properties for the table of contents.":"dIsPl4y 4 748L3 0F C0N73n7s f0r 4 p4g3. 34cH H34d3r 0R S3C7I0N 0n 7H3 p4g3 Is lIs73D 4s 4 lInK In 7H3 748L3 0F C0N73n7s. ClIcK \\\"S4V3\\\" n0w, 0r cLiCk \\\"m0r3 0p7i0nS\\\" 70 3Di7 7h3 Pr0p3r7i3s f0r 7H3 748L3 0F C0N73n7s.","You must specify a page name":"y0u mUs7 Sp3cIfY 4 P4G3 n4m3","Table of Contents":"748L3 0F C0N73n7s","Enter a tag and click \\\"Add tag\\\". The tag will be saved when you save the page.":"3N73r 4 74g 4Nd cLiCk \\\"4Dd 74g\\\". 7h3 74G WiLl 83 S4V3D Wh3n y0u s4v3 7h3 P4G3.","Optional properties include the name of the workspace to search, whether to search in the page title, text or tags, and whether to display full results or just page titles.":"0P7I0N4L Pr0p3r7i3s iNcLuD3 7H3 n4m3 0f 7H3 w0rKsP4C3 70 S34rCh, Wh37H3R 70 s34RcH In 7H3 p4g3 7i7l3, 73x7 0r 74gS, 4Nd wH37h3r 70 DiSpL4Y FuLl r3sUl7s 0R JuS7 p4g3 7i7l3s.","Preview":"pR3Vi3w","Add file":"4Dd fIl3","Optional properties include specifying which workspace to use and whether to display page titles or whole pages.":"0P7I0N4L Pr0p3r7i3s iNcLuD3 sP3CiFyInG WhIcH W0RkSp4c3 70 uS3 4Nd wH37h3r 70 DiSpL4Y P4G3 7I7L3S 0r wH0L3 p4g3s.","Expand zip archives and attach individual files to the page?":"3Xp4nD ZiP 4rChIv3s 4Nd 4774cH InDiViDu4l fIl3s 70 7h3 P4G3?","RSS feed URL:":"rSs f33D UrL:","No tag entered":"n0 74G 3n73R3D","error -> To send email, you must specify a recipient":"3Rr0r -> 70 s3nD 3m4iL, y0u mUs7 Sp3cIfY 4 R3CiPi3n7","Heading 5":"h34DiNg 5","Advanced content is shown inside a grey border. Switch to %1 to edit areas inside a grey border.":"4Dv4nC3D C0N73n7 Is sH0Wn iNsId3 4 Gr3y 80rD3R. sWi7cH 70 %1 70 3Di7 4r34S InSiD3 4 gR3Y 80Rd3r.","Filename is too long after URL encoding.":"fIl3n4m3 Is 700 l0nG 4f73R UrL 3nC0DiNg.","Optional properties include specifying a different page for the attachment, and link text.":"0P7I0N4L Pr0p3r7i3s iNcLuD3 sP3CiFyInG 4 DiFf3r3n7 P4G3 f0r 7H3 4774cHm3n7, 4Nd lInK 73X7.","Could not remove page from watchlist":"c0uLd n07 r3m0v3 P4G3 fR0M W47cHlIs7","Uploaded files:":"uPl04D3D FiL3S:","Display the results from a Google search. Use this form to edit the properties for the search.":"dIsPl4y 7H3 r3sUl7s fR0M 4 G00gL3 s34RcH. uS3 7HiS F0Rm 70 3dI7 7H3 pR0P3R7I3S F0R 7h3 S34rCh.","Display the contents of another page within the current page. Use this form to edit the properties for the page include.":"dIsPl4y 7H3 c0n73N7S 0f 4N07h3r p4g3 Wi7hIn 7H3 cUrR3N7 p4g3. uS3 7HiS F0Rm 70 3dI7 7H3 pR0P3R7I3S F0R 7h3 P4G3 iNcLuD3.","Skype Link":"sKyP3 lInK","Unlink":"uNlInK","There are no optional properties for unformatted text.":"7H3R3 4R3 n0 0p7i0n4l pR0P3R7I3S F0R UnF0Rm4773D 73X7.","Optional properties include the title of another page to which the image is attached, and link text. If link text is specified then a link to the image is displayed instead of the image.":"0P7I0N4L Pr0p3r7i3s iNcLuD3 7H3 7I7L3 0F 4n07H3R P4G3 70 WhIcH 7h3 Im4g3 Is 4774cH3D, 4Nd lInK 73X7. If lInK 73X7 iS Sp3cIfI3D 7h3n 4 lInK 70 7H3 iM4G3 iS DiSpL4Y3D InS734D 0f 7H3 iM4G3.","Heading 1":"h34DiNg 1","Search term:":"s34RcH 73Rm:","Upload file":"uPl04D FiL3","Unformatted":"uNf0rM4773d","Could not add page to watchlist":"c0uLd n07 4Dd p4g3 70 w47ChLiS7","Atom feed URL:":"470M F33d uRl:","There are no optional properties for page include.":"7H3R3 4R3 n0 0p7i0n4l pR0P3R7I3S F0R P4G3 iNcLuD3.","Optional properties include the text to display for the link, and a target section within the linked page.":"0P7I0N4L Pr0p3r7i3s iNcLuD3 7H3 73x7 70 dIsPl4y f0r 7H3 lInK, 4Nd 4 74rG37 S3C7I0N Wi7hIn 7H3 lInK3D P4G3.","Add another tag":"4Dd 4N07h3r 74g","Add another file":"4Dd 4N07h3r fIl3","selection_start: %1":"s3l3c7i0n_s74R7: %1","Unselect all pages":"uNs3l3c7 4lL P4G3S","Insert table":"iNs3r7 748l3","page does not exist":"p4g3 D03s n07 3XiS7","Display a link to an AIM screen name. The icon will show whether the person is online. Clicking the link will start an IM conversation with the person if your IM client is properly configured. Use this form to edit the properties of the link.":"dIsPl4y 4 lInK 70 4N 4iM ScR33n n4m3. 7H3 iC0N WiLl sH0W Wh37H3R 7h3 P3Rs0n iS 0nLiN3. ClIcKiNg 7H3 lInK WiLl s74R7 4N Im c0nV3Rs47I0N Wi7h 7H3 p3rS0N If y0uR Im cLi3n7 Is pR0P3RlY C0NfIgUr3d. Us3 7hIs f0rM 70 3Di7 7h3 Pr0p3r7i3s 0F 7h3 LiNk.","There are no optional properties for an Google search.":"7H3R3 4R3 n0 0p7i0n4l pR0P3R7I3S F0R 4n g00Gl3 S34rCh.","Text":"73x7","Underline":"uNd3rLiN3","Headers and<br/>sections in:":"h34D3Rs 4Nd<8R/>s3c7i0nS In:","Section name:":"s3c7i0n n4m3:","Bulleted List":"8UlL373D LiS7","Weblog Link":"w38L0G LiNk","Unformatted content:":"uNf0rM4773d c0n73N7:","Date in Local Time":"d473 In l0c4l 7Im3","Adding tag %1":"4DdInG 74G %1","Click \\\"Browse\\\" to find the file you want to upload. When you click \\\"Upload another file\\\" your file will be uploaded and added to the list of attachments for this page.":"cLiCk \\\"8R0Ws3\\\" 70 fInD 7h3 FiL3 y0u w4n7 70 uPl04D. wH3N Y0U ClIcK \\\"UpL04d 4N07h3r fIl3\\\" Y0Ur fIl3 WiLl 83 UpL04d3d 4Nd 4Dd3d 70 7h3 LiS7 0F 4774ChM3N7S F0R 7hIs p4g3.","Tag":"74g","Could not remove tag":"c0uLd n07 r3m0v3 74G","Display an image on this page. The image must be already uploaded as an attachment to this page or another page. Use this form to edit the properties of the displayed image.":"dIsPl4y 4N Im4g3 0n 7HiS P4G3. 7h3 Im4g3 MuS7 83 4lR34dY UpL04d3d 4S 4n 4774cHm3n7 70 7HiS P4G3 0R 4n07H3R P4G3. Us3 7hIs f0rM 70 3Di7 7h3 Pr0p3r7i3s 0F 7h3 DiSpL4Y3D Im4g3.","Italic":"i74LiC","You must select two revisions to compare.":"y0u mUs7 S3L3C7 7W0 r3vIsI0Ns 70 C0Mp4r3.","User's email:":"uS3R'S 3m4iL:","Enter your destination url here:":"3N73r y0uR D3S7In47I0N UrL H3R3:","Weblog on:":"w38L0G 0n:","External Link":"3X73rN4L LiNk","Save":"s4v3","Use %1 to change the number of rows and columns in a table.":"uS3 %1 70 cH4Ng3 7h3 NuM83r 0F R0Ws 4Nd c0lUmNs iN 4 748l3.","in:":"iN:","the workspace named":"7H3 w0rKsP4C3 n4m3d","Display a link to a Skype name. Clicking the link will start a Skype call with the person if your Skype client is properly configured. Use this form to edit the properties of the link.":"dIsPl4y 4 lInK 70 4 sKyP3 n4m3. cLiCkInG 7h3 LiNk wIlL S74r7 4 SkYp3 C4Ll wI7H 7h3 P3Rs0n iF Y0Ur sKyP3 cLi3n7 Is pR0P3RlY C0NfIgUr3d. Us3 7hIs f0rM 70 3Di7 7h3 Pr0p3r7i3s 0F 7h3 LiNk.","You must check at least one page in order to create a Word document.":"y0u mUs7 Ch3cK 47 l34S7 0N3 p4g3 In 0Rd3r 70 Cr3473 4 w0rD D0CuM3N7.","'%1' is a required field":"'%1' Is 4 r3qUiR3D Fi3lD","Insert...":"iNs3r7...","Title":"7I7L3","Tag List":"74g lIs7","Other workspace:":"07h3r w0rKsP4C3:","error -> \\\"%1\\\" is not a valid email address":"3Rr0r -> \\\"%1\\\" iS N07 4 V4LiD 3m4iL 4dDr3sS","Yahoo! IM Link":"y4h00! Im lInK","This is not an editable widget. Please edit it in advanced mode.":"7HiS Is n07 4N 3dI748L3 wIdG37. pL34s3 3dI7 i7 In 4Dv4nC3D M0D3.","Insert attachment":"iNs3r7 4774ChM3N7","Uploading %1...":"uPl04DiNg %1...","That seems like a bit too large for a table.":"7H47 S33mS LiK3 4 8I7 700 l4rG3 f0r 4 748L3.","the current page":"7H3 cUrR3N7 p4g3","Tag Link":"74g lInK","Increase Indent":"iNcR34s3 InD3N7","%asis_content":"%4sIs_c0n73N7","There are no optional properties for an AIM link.":"7H3R3 4R3 n0 0p7i0n4l pR0P3R7I3S F0R 4n 4Im lInK.","Untitled Page":"uN7I7L3D P4G3","Advanced Content in Grey Border":"4Dv4nC3D C0N73n7 In gR3Y 80Rd3r","[Style]":"[S7Yl3]","Display a list of pages recently changed in a workspace. By default only the page titles are displayed. Use this form to edit the list properties.":"dIsPl4y 4 lIs7 0f p4g3s r3c3n7lY Ch4nG3D In 4 w0rKsP4C3. 8y d3f4uL7 0NlY 7h3 P4G3 7I7L3S 4r3 DiSpL4Y3D. uS3 7HiS F0Rm 70 3dI7 7H3 lIs7 Pr0p3r7i3s.","Horizontal Rule":"h0rIz0n74L RuL3","Click \\\"Browse\\\" to find the file you want to upload. When you click \\\"Add file,\\\" this file will be added to the list of attachments for this page, and uploaded when you save the page.":"cLiCk \\\"8R0Ws3\\\" 70 fInD 7h3 FiL3 y0u w4n7 70 uPl04D. wH3N Y0U ClIcK \\\"4dD FiL3,\\\" 7hIs fIl3 WiLl 83 4dD3D 70 7H3 lIs7 0f 4774cHm3n7s f0r 7HiS P4G3, 4nD UpL04d3d wH3N Y0U S4V3 7H3 p4g3.","Heading 3":"h34DiNg 3","Please enter the number of table rows:":"pL34s3 3n73R 7h3 NuM83r 0F 748l3 R0Ws:","Fewer options":"f3w3r 0P7I0Ns","type link text here":"7Yp3 LiNk 73x7 H3R3","Strikethrough":"s7rIk37Hr0uGh","Bold":"80lD","Unexpected Widget >>%1<< in parseWidget":"uN3Xp3c73D WiDg37 >>%1<< In p4rS3WiDg37","You have unsaved changes. Do you want to save those changes? If you click 'OK', all edit changes will be lost. Click 'Cancel' if you want to save changes before navigating away from this page.":"y0u h4v3 UnS4V3D Ch4nG3S. d0 Y0U W4N7 70 S4V3 7H0S3 cH4Ng3s? If y0u cLiCk '0k', 4Ll 3Di7 Ch4nG3S WiLl 83 L0S7. ClIcK 'c4nC3L' iF Y0U W4N7 70 S4V3 cH4Ng3s 83f0r3 N4ViG47iNg 4W4Y Fr0m 7HiS P4G3.","\\\",\\\"":"\\\",\\\"","Numbering":"nUm83RiNg","Files To upload:":"fIl3s 70 UpL04d:","Display a list of the most recently changed pages in a workspace that have a specific tag. By default only the page title is displayed. Use this form to edit the list properties.":"dIsPl4y 4 lIs7 0f 7H3 m0s7 R3C3N7Ly cH4Ng3d p4g3s iN 4 W0RkSp4c3 7h47 h4v3 4 Sp3cIfIc 74g. 8y d3f4uL7 0NlY 7h3 P4G3 7I7L3 iS DiSpL4Y3D. uS3 7HiS F0Rm 70 3dI7 7H3 lIs7 Pr0p3r7i3s.","Click \\\"Browse\\\" to find the file you want to upload. When you click \\\"Add another file,\\\" these files will be added to the list of attachments for this page, and uploaded when you save the page.":"cLiCk \\\"8R0Ws3\\\" 70 fInD 7h3 FiL3 y0u w4n7 70 uPl04D. wH3N Y0U ClIcK \\\"4dD 4n07H3R FiL3,\\\" 7h3s3 FiL3S WiLl 83 4dD3D 70 7H3 lIs7 0f 4774cHm3n7s f0r 7HiS P4G3, 4nD UpL04d3d wH3N Y0U S4V3 7H3 p4g3.","Heading 2":"h34DiNg 2","Weblog name:":"w38L0G N4M3:","Add a link to this attachment at the top of the page? Images will appear in the page.":"4Dd 4 lInK 70 7HiS 4774ChM3N7 47 7h3 70P 0f 7H3 p4g3? iM4G3S WiLl 4Pp34R In 7H3 p4g3.","Please select the text you would like to turn into a link.":"pL34s3 S3L3C7 7H3 73x7 Y0U W0UlD LiK3 70 7uRn iN70 4 LiNk.","There are no optional properties for a Yahoo! link.":"7H3R3 4R3 n0 0p7i0n4l pR0P3R7I3S F0R 4 Y4H00! lInK.","Search type:":"s34RcH 7yP3:","Display the full name for the given email address or user name. Use this form to edit the properties of the user name.":"dIsPl4y 7H3 fUlL N4M3 f0r 7H3 gIv3n 3M4Il 4DdR3Ss 0R Us3r n4m3. uS3 7HiS F0Rm 70 3dI7 7H3 pR0P3R7I3S 0f 7H3 uS3R N4M3.","Plese click \\\"Browse\\\" and select a file to upload.":"pL3S3 cLiCk \\\"8R0Ws3\\\" 4nD S3L3C7 4 fIl3 70 uPl04D.","You must check at least one page in order to create a PDF.":"y0u mUs7 Ch3cK 47 l34S7 0N3 p4g3 In 0Rd3r 70 Cr3473 4 pDf.","the page titled":"7H3 p4g3 7i7l3d","Skype name:":"sKyP3 n4m3:","Select a form and generates a new form page.":"s3l3c7 4 F0Rm 4Nd g3n3r473s 4 n3w f0rM P4G3.","Include an Image":"iNcLuD3 4N Im4g3","More options":"m0r3 0p7i0nS","Create Link":"cR3473 LiNk","More Indented":"m0r3 InD3N73d","Display the results for a Technorati search. Use this form to edit the properties for the search.":"dIsPl4y 7H3 r3sUl7s f0r 4 73cHn0r47I S34rCh. Us3 7hIs f0rM 70 3Di7 7h3 Pr0p3r7i3s f0r 7H3 s34RcH.","Preformatted":"pR3F0Rm4773D","Full results:":"fUlL R3SuL7S:","Optional parameters include specifying which workspace to use and whether to display page titles or whole pages.":"0P7I0N4L P4R4M373Rs iNcLuD3 sP3CiFyInG WhIcH W0RkSp4c3 70 uS3 4Nd wH37h3r 70 DiSpL4Y P4G3 7I7L3S 0r wH0L3 p4g3s.","Numbered List":"nUm83R3D LiS7","Insert Socialtext link":"iNs3r7 S0Ci4l73X7 lInK","Images":"iM4G3S","Heading 4":"h34DiNg 4","Optionally, specify which page's headers and sections to use for the table of contents.":"0P7I0N4LlY, sP3CiFy wHiCh p4g3'S H34d3rS 4nD S3C7I0Ns 70 Us3 F0R 7h3 748l3 0f c0n73N7S.","You must select one of the options or click cancel":"y0u mUs7 S3L3C7 0N3 0F 7h3 0p7i0nS 0r cLiCk c4nC3L","Google Search":"g00Gl3 S34rCh","Attached to:":"4774cH3D 70:","About Wikiwyg":"480U7 wIkIwYg","Display a link to a Convoq name. Clicking the link will start a Convoq call with the person if your Convoq client is properly configured. Use this form to edit the properties of the Convoq link.":"dIsPl4y 4 lInK 70 4 c0nV0Q N4M3. ClIcKiNg 7H3 lInK WiLl s74R7 4 c0nV0Q C4Ll wI7H 7h3 P3Rs0n iF Y0Ur c0nV0Q ClI3N7 iS Pr0p3rLy c0nFiGuR3D. uS3 7HiS F0Rm 70 3dI7 7H3 pR0P3R7I3S 0f 7H3 c0nV0Q LiNk.","Convoq name:":"c0nV0Q N4M3:","Page title:":"p4g3 7i7l3:","Display a link to a weblog. Use this form to edit the properties of the link.":"dIsPl4y 4 lInK 70 4 w38L0G. uS3 7HiS F0Rm 70 3dI7 7H3 pR0P3R7I3S 0f 7H3 lInK.","File size exceeds maximum limit. File was not uploaded.":"fIl3 SiZ3 3Xc33Ds m4xImUm lImI7. FiL3 w4s n07 uPl04D3D.","Error":"3Rr0r","Section Marker":"s3c7i0n m4rK3R","Yahoo! ID:":"y4h00! Id:","There are no optional properties for a section marker.":"7H3R3 4R3 n0 0p7i0n4l pR0P3R7I3S F0R 4 S3C7I0N M4Rk3r.","There are no optional properties for a user name.":"7H3R3 4R3 n0 0p7i0n4l pR0P3R7I3S F0R 4 Us3r n4m3.","That doesn't appear to be a valid number.":"7H47 D03sN'7 4pP34r 70 83 4 v4lId nUm83R.","There are no optional properties for a new form page.":"7H3R3 4R3 n0 0p7i0n4l pR0P3R7I3S F0R 4 N3W F0Rm p4g3.","File attached to:":"fIl3 4774Ch3d 70:","Please click browse and select a file to upload.":"pL34s3 ClIcK 8r0wS3 4Nd s3l3c7 4 FiL3 70 UpL04d.","Remove %1 from the queue":"r3m0v3 %1 fR0M 7h3 Qu3u3","<span class=\\\"st-tags-nomatch\\\">No matches</span>":"<Sp4n cL4Ss=\\\"s7-74Gs-n0m47Ch\\\">n0 M47cH3S</sP4N>","Please enter the number of table columns:":"pL34s3 3n73R 7h3 NuM83r 0F 748l3 C0LuMnS:","Display the given date and time in the individually-set time zone for each reader. Use this form to edit the date and time to be displayed":"dIsPl4y 7H3 gIv3n d473 4nD 7iM3 iN 7h3 InDiViDu4lLy-s37 7Im3 Z0N3 f0r 34cH R34d3r. Us3 7hIs f0rM 70 3Di7 7h3 D473 4Nd 7Im3 70 83 DiSpL4Y3D","Display a link to a Yahoo! instant message ID. The icon will show whether the person is online. Clicking the link will start an IM conversation with the person if your IM client is properly configured. Use this form to edit the properties of the link.":"dIsPl4y 4 lInK 70 4 y4h00! InS74n7 M3Ss4g3 Id. 7h3 Ic0n wIlL Sh0w wH37h3r 7H3 p3rS0N Is 0NlIn3. cLiCkInG 7h3 LiNk wIlL S74r7 4n iM C0Nv3rS47i0n wI7H 7h3 P3Rs0n iF Y0Ur iM ClI3N7 iS Pr0p3rLy c0nFiGuR3D. uS3 7HiS F0Rm 70 3dI7 7H3 pR0P3R7I3S 0f 7H3 lInK.","Replace this text with your own.":"r3pL4C3 7HiS 73X7 wI7H Y0Ur 0Wn.","There are no optional properties for a date display.":"7H3R3 4R3 n0 0p7i0n4l pR0P3R7I3S F0R 4 D473 dIsPl4y.","Include unformatted text in the page. This text will not be treated as wiki text. Use this form to edit the text.":"iNcLuD3 uNf0rM4773d 73x7 In 7H3 p4g3. 7HiS 73X7 wIlL N07 83 7R3473d 4S WiKi 73x7. uS3 7HiS F0Rm 70 3dI7 7H3 73x7.","the current workspace":"7H3 cUrR3N7 w0rKsP4C3","Attachment Link":"4774cHm3n7 LiNk","Use this form to edit the properties of the link to a page section.":"uS3 7HiS F0Rm 70 3dI7 7H3 pR0P3R7I3S 0f 7H3 lInK 70 4 p4g3 S3C7I0N.","Decrease Indent":"d3cR34s3 InD3N7","Tag name:":"74g n4m3:","Bullets":"8UlL37s","These tags have been removed:":"7H3S3 74gS H4V3 833N R3M0V3D:","New search":"n3w s34RcH","\\\"%1\\\" is a reserved page name. Please use a different name":"\\\"%1\\\" Is 4 r3s3rV3D P4G3 n4m3. pL34s3 Us3 4 DiFf3r3n7 N4M3","Use this form to edit the properties of the link.":"uS3 7HiS F0Rm 70 3dI7 7H3 pR0P3R7I3S 0f 7H3 lInK.","Attachments":"4774cHm3n7s","Display a list of the most recent entries from a weblog in a workspace. By default only the weblog entry names are displayed. Use this form to edit the list properties.":"dIsPl4y 4 lIs7 0f 7H3 m0s7 R3C3N7 3N7Ri3s fR0M 4 W38l0g iN 4 W0RkSp4c3. 8Y D3F4Ul7 0nLy 7H3 w38L0G 3n7rY N4M3S 4r3 DiSpL4Y3D. uS3 7HiS F0Rm 70 3dI7 7H3 lIs7 Pr0p3r7i3s.","You have unsaved changes. Are you sure you want to navigate away from this page? If you click 'OK', all edit changes will be lost. Click 'Cancel' if you want to save changes and stay on the current page.":"y0u h4v3 UnS4V3D Ch4nG3S. 4R3 y0u sUr3 Y0U W4N7 70 N4ViG473 4W4Y Fr0m 7HiS P4G3? If y0u cLiCk '0k', 4Ll 3Di7 Ch4nG3S WiLl 83 L0S7. ClIcK 'c4nC3L' iF Y0U W4N7 70 S4V3 cH4Ng3s 4Nd s74Y 0n 7H3 cUrR3N7 p4g3.","Table & Advanced Editing":"748L3 & 4Dv4nC3D 3dI7InG","Optional properties include the text to display for the link, and the title of a different page.":"0P7I0N4L Pr0p3r7i3s iNcLuD3 7H3 73x7 70 dIsPl4y f0r 7H3 lInK, 4Nd 7H3 7I7L3 0F 4 DiFf3r3n7 P4G3.","Advanced Mode":"4Dv4nC3D M0D3","Link to a Section":"lInK 70 4 s3c7i0n","Page Include":"p4g3 InClUd3","If you click 'OK', all edit changes will be lost!":"iF Y0U ClIcK '0K', 4lL 3dI7 cH4Ng3s wIlL 83 l0s7!","or":"0R","Strike Through":"s7rIk3 7hR0UgH","Search for:":"s34RcH F0R:","Removing tag %1":"r3m0vInG 74G %1","Search:":"s34RcH:","Inter-workspace link":"iN73r-w0rKsP4C3 lInK","Select all pages":"s3l3c7 4lL P4G3S","Search Results":"s34RcH R3SuL7S","Link text:":"lInK 73X7:","Insert web link":"iNs3r7 W38 LiNk","Add a section marker at the current cursor location. You can link to a section marker using a \\\"Section Link\\\". Use this form to edit the properties for the section marker.":"4Dd 4 s3c7i0n m4rK3R 47 7H3 cUrR3N7 cUrS0R L0C47i0n. Y0U C4N LiNk 70 4 S3C7I0N M4Rk3r uSiNg 4 \\\"s3c7i0n lInK\\\". uS3 7HiS F0Rm 70 3dI7 7H3 pR0P3R7I3S F0R 7h3 S3C7I0N M4Rk3r.","Workspace:":"w0rKsP4C3:","Page in:":"p4g3 In:","Are you sure you want to delete this page?":"4R3 y0u sUr3 Y0U W4N7 70 D3L373 7HiS P4G3?","Heading 6":"h34DiNg 6","Less Indented":"l3sS InD3N73d","Optional properties include link text, and the name of a different workspace for the tags.":"0P7I0N4L Pr0p3r7i3s iNcLuD3 lInK 73X7, 4nD 7h3 N4M3 0F 4 DiFf3r3n7 W0RkSp4c3 F0R 7h3 74Gs.","There are no optional properties for an RSS feed.":"7H3R3 4R3 n0 0p7i0n4l pR0P3R7I3S F0R 4n rSs f33D.","Attached Image":"4774cH3D Im4g3","Watch this page":"w47Ch 7HiS P4G3","Other page in:":"07h3r p4g3 In:","Insert image":"iNs3r7 Im4g3","YYYY-MM-DD&nbsp;HH:MM:SS:":"yYyY-Mm-dD&N8Sp;hH:Mm:sS:","Page Title required if Workspace Id specified":"p4g3 7i7l3 R3QuIr3d iF W0RkSp4c3 Id sP3CiFi3d","No matches":"n0 M47cH3S","Safari does not support simple mode editing":"s4f4rI D03s n07 sUpP0R7 sImPl3 M0D3 3Di7iNg","Expand zip archive and attach individual files to the page?":"3Xp4nD ZiP 4rChIv3 4nD 4774Ch iNdIvIdU4L FiL3S 70 7H3 p4g3?","Add tag":"4Dd 74g","There are no optional properties for a Technorati search.":"7H3R3 4R3 n0 0p7i0n4l pR0P3R7I3S F0R 4 73ChN0R47i s34RcH.","Display the content of an RSS feed. Use this form to edit the properties of the inline RSS feed.":"dIsPl4y 7H3 c0n73N7 0F 4n rSs f33D. uS3 7HiS F0Rm 70 3dI7 7H3 pR0P3R7I3S 0f 7H3 iNlIn3 RsS F33d.","Upload another file":"uPl04D 4n07H3R FiL3","AIM screen name:":"4Im sCr33N N4M3:","Technorati Search":"73cHn0r47I S34rCh","There are no optional properties for a Skype link.":"7H3R3 4R3 n0 0p7i0n4l pR0P3R7I3S F0R 4 SkYp3 LiNk.","What's New":"wH47'S N3W","Inline Atom":"iNlIn3 470m","Optional properties include link text, and the name of a different workspace for the weblog.":"0P7I0N4L Pr0p3r7i3s iNcLuD3 lInK 73X7, 4nD 7h3 N4M3 0F 4 DiFf3r3n7 W0RkSp4c3 F0R 7h3 W38l0g.","Watching this page":"w47ChInG 7hIs p4g3","Normal Text":"n0rM4L 73X7","Add links to these attachments at the top of the page? Images will appear in the page.":"4Dd lInKs 70 7h3s3 4774ChM3N7S 47 7H3 70p 0F 7h3 P4G3? Im4g3s wIlL 4pP34r iN 7h3 P4G3.","There are no optional properties for an Atom feed.":"7H3R3 4R3 n0 0p7i0n4l pR0P3R7I3S F0R 4n 470M F33d.","Weblog List":"w38L0G LiS7","Saving...":"s4vInG...","New Form Page":"n3w f0rM P4G3","AIM Link":"4Im lInK","Form name:":"f0rM N4M3:"}};
